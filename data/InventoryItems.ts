...
const INVENTORY_ITEMS: InventoryItem[] = [
    {
        ...
        imgUrl: '/static/media/sauce-backpack-1200x1500.0a0b85a3.jpg',
        description: (`carry.allTheThings() with the sleek, streamlined` + 
            ` Sly Pack that melds uncompromising style with unequaled` + 
            ` laptop and tablet protection.`),
        price: 29.99,
    },
    {
        name: 'Sauce Labs Bike Light',
        imgUrl: '/static/media/bike-light-1200x1500.37c843b0.jpg',
        description: (`A red light isn't the desired state in testing but` + 
            ` it sure helps when riding your bike at night. Water-resistant` + 
            ` with 3 lighting modes, 1 AAA battery included.`),
        price: 9.99,
    },
    {
        name: 'Sauce Labs Bolt T-Shirt',
        imgUrl: '/static/media/bolt-shirt-1200x1500.c2599ac5.jpg',
    ...
    },
    {
        ...
        imgUrl: '/static/media/sauce-pullover-1200x1500.51d7ffaf.jpg',
        description: (`It's not every day that you come across a midweight` + 
    ...
    },
    {
        ...
        imgUrl: '/static/media/red-onesie-1200x1500.2ec615b2.jpg',
        description: (`Rib snap infant onesie for the junior automation engineer` + 
            ` in development. Reinforced 3-snap bottom closure, two-needle hemmed` + 
            ` sleeved and bottom won't unravel.`),
        price: 7.99
    },
    {
        name: 'Test.allTheThings() T-Shirt (Red)',
        imgUrl: '/static/media/red-tatt-1200x1500.30dadef4.jpg',
        description: (`This classic Sauce Labs t-shirt is perfect to wear when` + 
            ` cozying up to your keyboard to automate a few tests. Super-soft and` + 
